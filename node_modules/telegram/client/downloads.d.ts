...
export declare function downloadMedia(client: TelegramClient, messageOrMedia: Api.Message | Api.TypeMessageMedia | Message, args: DownloadMediaInterface): Promise<Buffer>;
