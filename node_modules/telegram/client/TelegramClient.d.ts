...
export declare class TelegramClient extends TelegramBaseClient {
    ...
    downloadMedia(messageOrMedia: Api.Message | Api.TypeMessageMedia | Message, args: DownloadMediaInterface): Promise<Buffer>;
    ...
    iterMessages(entity: EntityLike | undefined, params: messageMethods.IterMessagesParams): messageMethods._MessagesIter | messageMethods._IDsIter;
    getMessages(entity: EntityLike | undefined, params: messageMethods.IterMessagesParams): Promise<import("../Helpers").TotalList<Message>>;
    sendMessage(entity: EntityLike, params: messageMethods.SendMessageParams): Promise<Api.TypeUpdates>;
    editMessage(entity: EntityLike, params: messageMethods.EditMessageParams): Promise<Api.TypeUpdates>;
    iterDialogs(params: dialogMethods.IterDialogsParams): dialogMethods._DialogsIter;
