...
export declare class TelegramBaseClient {
    ...
    constructor(session: string | Session, apiId: number, apiHash: string, { connection, useIPV6, timeout, requestRetries, connectionRetries, retryDelay, downloadRetries, autoReconnect, sequentialUpdates, floodSleepThreshold, deviceModel, systemVersion, appVersion, langCode, systemLangCode, baseLogger, useWSS, }: TelegramClientParams);
